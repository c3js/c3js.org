...
activate :sync do |sync|
  ...
  sync.aws_access_key_id = 'AKIAIOQMRC4DM4IDRRJQ' # Your Amazon S3 access key
  sync.aws_secret_access_key = 'cI4n4jnRC0oxX7u0WWLTgyZKyqdnbD1ZutU5Rc2X' # Your Amazon S3 access secret
